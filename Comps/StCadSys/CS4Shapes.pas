...
type
  ...
  public
    {: Create a new text entity in the rectangle <I=Rect1>, with
       ...
       If you donít know the dimension of the Text on screen, set
  ...
  {: This class rapresents a scalable raster bitmap.
     ...
     applications. However this object isnít fast and sometimes
...
begin
  ...
  for Cont := 1 to Length(Str) do
   begin
     ...
     if Str[Cont] = #13 then
      begin
        // New line. L'altezza Ë 1.3 per via delle gambette.
...
begin
  ...
  try
    ...
    LogFont.lfEscapement :=0 * 10; //     Û„ÓÎ ÔÓ‚ÓÓÚ‡ round(TmpTransf[1, 2]);
