...
{$ENDIF}
    ...
    {okey: зерезана процедура для оптимизации ширины колонки и перенесена в public
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        ExcecuteDBGridEhFindDialog(Grid, SelText, '', nil, Grid.IsFindDialogShowAsModal);
      end else
...
begin
  ...
  if (ShortCut(Key, Shift) = DBGridEhSetValueFromPrevRecordKey) then
    ...
    begin
      StopInplaceSearch;
      ExcecuteDBGridEhFindDialog(Self, '', '', nil, IsFindDialogShowAsModal);
    end else
...
begin
  ...
  {    InplaceFilterEdit.Items.Assign(Column.Filter.FList);
      ...
      InplaceFilterEdit.ListSource := nil;
      InplaceFilterEdit.ListField := Column.STFilter.ListField;
  ...
  {    InplaceFilterEdit.KeyItems.Clear;
      ...
      InplaceFilterEdit.Value := Null;
      InplaceFilterEdit.Style := csDropDownEh;
      InplaceFilterEdit.OnButtonClick := OnFilterEditButtonClick; // To allow edit;
      InplaceFilterEdit.ListSource := nil;
      InplaceFilterEdit.ListField := '';
      InplaceFilterEdit.KeyField := '';
