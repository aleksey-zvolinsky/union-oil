unit uRichEditFormat;
{ Создан 18.10.2004 Должиковым
}

interface

uses uCommonForm,  Comctrls,Classes, SysUtils, Graphics,uOilQuery,Ora, uOilStoredProc;

procedure SetRichEditText(var p_RE: TRichEdit; p_Text: string);
procedure ReadTextTags(p_Text: string; slTags: TStringList; var s: string);
